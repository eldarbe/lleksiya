...
# break полносю выходит из сикла 


# continue перейти к следуещей итерации 
# начинает следуещий проход цикла минуя минуя оставшивсяя тело цикла
...
#'''''''else в циклах  проверяет был ли произведен выход из цикла инструкциой break или 
#естественным путем блок кода в else выполнит толоко 
